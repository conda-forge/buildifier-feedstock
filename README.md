...
Documentation: https://github.com/bazelbuild/buildtools/blob/10.1.0/buildifier/README.md
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/buildifier-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/buildifier-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install buildifier
```
...
It is possible to list all of the versions of `buildifier` available on your platform:
...
```
pixi search buildifier --channel conda-forge
```
